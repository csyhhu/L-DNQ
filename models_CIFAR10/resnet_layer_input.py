...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, layer_name, block_index, \
        ...
        layer_stride['layer%s.%s.conv2' % (layer_name, block_index)] = 1
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, layer_name, block_index, \
        ...
        layer_padding['layer%s.%s.conv1' % (layer_name, block_index)] = 0
        ...
        layer_padding['layer%s.%s.conv3' % (layer_name, block_index)] = 0
...
class ResNet_Cifar(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):
        ...
        self.layer_kernel = {'conv1': 3}
        self.layer_stride = {'conv1': 1}
        self.layer_padding = {'conv1': 1}

        self.inplanes = 16
        self.conv1 = nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(16)
        self.relu = nn.ReLU(inplace=True)
        self.layer1 = self._make_layer(block, 16, layers[0], layer_name='1')
        self.layer2 = self._make_layer(block, 32, layers[1], layer_name='2', stride=2)
        self.layer3 = self._make_layer(block, 64, layers[2], layer_name='3', stride=2)
